...
#write csv
write.csv(L1_all_summary_table,"~/Downloads/Tloop_CNCbl/output_summary_files/L1_all_summary_file.csv", row.names = TRUE)

#remove the switches below the functional cutoff of 2.0
#find the FI median
L1_summary_table <- subset(L1_all_summary_table, FI>2.0)
#write csv
write.csv(L1_summary_table,"~/Downloads/Tloop_CNCbl/output_summary_files/L1_summary_file.csv", row.names = TRUE)
#write excel
write.xlsx(L1_summary_table, '~/Downloads/Tloop_CNCbl/output_summary_files/L1_summary_file.xlsx', rowNames = TRUE)
write.xlsx(L1_all_summary_table, '~/Downloads/Tloop_CNCbl/output_summary_files/L1__all_summary_file.xlsx', rowNames = TRUE)
```
