...
#write csv
write.csv(L4_all_summary_table,"~/Downloads/Tloop_CNCbl/output_summary_files/L4_all_summary_file.csv", row.names = TRUE)

#remove the switches below the functional cutoff of 2.0
#find the FI median
L4_summary_table <- subset(L4_all_summary_table, FI>2.0)
#write csv
write.csv(L4_summary_table,"~/Downloads/Tloop_CNCbl/output_summary_files/L4_summary_file.csv", row.names = TRUE)
#write excel
write.xlsx(L4_summary_table, '~/Downloads/Tloop_CNCbl/output_summary_files/L4_summary_file.xlsx', rowNames = TRUE)
write.xlsx(L4_all_summary_table, '~/Downloads/Tloop_CNCbl/output_summary_files/L4__all_summary_file.xlsx', rowNames = TRUE)
```
